...
int p9110()
{
    ...
    string _String;
    string s;
    string consonants = "bcdfghjlkmnpqrstvwxz";
    ...
    for (auto& i : stringlist)
                 ...
                 {                                      
                     if(variableString == i)
                     {
                         ...
                         if(count >= 4)
                         {
                             ...
                             printf("Good\n");
                             variableList.append(variableString);
        ...
        //           count++;
        //           continue;
        //       //  _String.erase(remove(_String.begin(),_String.end(),_String[j]));                    
                 }

    for (auto& i : variableList)
    {
        printf("%s",variableList[i]);
